...
public class C01_Abstract {   /*
    1- Bazı durumlarda child class'lar parent class'daki method'ların genellikle bodylerine değiştirerek override ederler.
    ...
    11- Abs Class'da static ve abs method tanımlanamaz CTE-> static method override edilemeyecegi için abs olamaz
