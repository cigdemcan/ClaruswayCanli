 ...
 */
        ...
        System.out.println(str.indexOf("C"));//parametrenın tipi değişmiş
    ...
    public static void topla(double sayi1, int sayi2) {//farklı type kullanıldı
        System.out.println("double-int type method çalıştı ->" + (sayi1 + sayi2));
    }

    public static void topla(int sayi1, double sayi2) {//sıra değişti
