...
public class C07_containsKey_containsValue {
    public static void main(String[] args) {
        ...
        //mapcontainsValue();->Girilen  value değerinin map de varlıgını kontrol eder boolean return eder
        ...
        System.out.println("hm.containsValue(\"ebikGabık Euro\") = " + hm.containsValue("ebikGabık Euro"));//false
    }
}
