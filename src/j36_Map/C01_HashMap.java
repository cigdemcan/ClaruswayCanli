...
1) HashMap: HasMap key-value yapisini kullanir.Key degeri benzersiz (unique)olmalı duplicate kabul etmaz
 ...
 */
        ...
        hm.put("null","200 Euro");//key null değeri kabul eder 
        hm.put("null","222 Euro");//tekrarlı key değerine value update edilir .Aynı key kullanılırsa üzerine atama yapılır
        ...
        //map saut komutuna parametre olarak prınt edilir
        System.out.println("hm = " + hm);//{ MediaMarkt=183 Euro, null=222 Euro, Saturn=300 Euro, Ebay= null, Apple store=500 Euro, Amazon=296 Euro, Vatan=111 Euro}
    }
}
