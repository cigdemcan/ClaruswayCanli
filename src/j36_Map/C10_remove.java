...
public class C10_remove {
    public static void main(String[] args) {
        ...
        //map.remove();-:>Girilen entry map de varsasiler ve true return eder yoksa false return eder
        //parametre olarak entry degil sadece key deger girilirse key varsa siler ve key value sı return eder.yoksa null return eder
