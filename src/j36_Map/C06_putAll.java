...
public class C06_putAll {
    public static void main(String[] args) {
        ...
        //map.putAll(map1);-:>Girilen  map`iistenen map`e ekler
        ...
        //cincik code...
        HashMap<String ,String> hm2=new HashMap<>(hm1);//hm2 map hem tanımlandı hem de entry olarak hm1 parametre olarak entry atandı
