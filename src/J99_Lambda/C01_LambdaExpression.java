...
public class C01_LambdaExpression {
    ...
    public static void printElFunctional(List<Integer> sayi) {//Functinol pr
        sayi.//aksıyona gorecek lıst coll.
                stream().//lıst elemanlarını yukarıdan asgıya akısa alır
                forEach((t) -> System.out.print(t + ""));//datanın parametresine gore akıstakı her bır elemanı işleme sokar
        /*
    ...
    */
    ...
    //Task:
    public static void printElFunctional1(List<Integer> sayi) {//Functinol pr
        sayi.//aksıyona gorecek lıst coll.
                stream().//lıst elemanlarını yukarıdan asgıya akısa alır
                forEach((System.out::print));//method referance->System.out.print method coll edildi
        //method kaynagı ::method->meth referance
    }
    public  static void yazdır(int a){//normal method tek aksiyonlu->seed method(tohum)->refere edilecek method
        System.out.println(a+" ");

    }
    public static void printElFunctional2(List<Integer> sayi) {//Functinol pr
        sayi.//aksıyona gorecek lıst coll.
                stream().//lıst elemanlarını yukarıdan asgıya akısa alır
                forEach((C01_LambdaExpression::yazdır));//method referance->System.out.print method coll edildi
        //method kaynagı ::method->meth referance
    }
