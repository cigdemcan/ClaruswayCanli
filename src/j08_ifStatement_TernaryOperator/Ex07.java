...
public class Ex07 {
    public static void main(String[] args) {
        /*TASK->Kullanıcının ehliyetini kontrol ediniz
        ehliyeti varsa yıl tecrübesi 7 yıl ve üstü ise aldığı mesafe 100000 km ve üzeri ise kontak anahtarını veriniz
        aksi durumda tecrübe yılı ve mesafe eksiklerini print eden code creata ediniz
         */
