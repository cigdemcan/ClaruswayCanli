...
//task->verilen Stringlerin en fazla  karakter sayısını print eden code creata ediniz(parametre sayısı belli degil:varargs
        ...
        public static void topla(int a, int b,int c){//uc p'li overload meth
