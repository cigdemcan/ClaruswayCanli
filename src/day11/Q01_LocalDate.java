...
public static void main(String[] args) {
    ...
    LocalDate değşenTarih=bugun.plusDays(1).plusMonths(1).plusYears(1);
    System.out.println("değşenTarih = " + değşenTarih);
    LocalDate sonTarih=değşenTarih.minusDays(3).minusMonths(2).minusYears(5);
