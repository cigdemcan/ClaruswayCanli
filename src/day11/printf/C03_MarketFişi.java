...
public class C03_MarketFişi {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=================================");
        double toplamUrrunMiktari=0;
        for (int i = 0; i < miktar.length; i++) {
            toplamUrrunMiktari+=miktar[i];
        ...
        System.out.printf("toplam   \t   %5.2fkg  \t  %12.2f€",toplamUrrunMiktari,toplamOdenecekPara);
    }
}
