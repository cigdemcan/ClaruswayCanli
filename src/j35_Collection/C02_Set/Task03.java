 ...
 */
        HashSet<String>hs1=new HashSet<>(Arrays.asList("Germany" , "Turkıye" , "South Africa" , "Brazil" , "USA"));
        HashSet<String>hs2=new HashSet<>(Arrays.asList("Germany" , "Turkıye" , "Brazil" , "France" , "USA"));
