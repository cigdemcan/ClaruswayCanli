...
public class C04_LocalTimeFormatter {
        ...
        DateTimeFormatter dtf=DateTimeFormatter.ofPattern("dd - MM - YYYY");//gub ay ismi ve yıl formatı tanımlandı
        System.out.println("dtf.format(ldt) = " + dtf.format(ldt));//25 - Ekim - 2022

        DateTimeFormatter dtf1=DateTimeFormatter.ofPattern("HH:mm:ss");//saat dakika saniye ay format tanımlandı
