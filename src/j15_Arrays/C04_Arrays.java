...
public class C04_Arrays {
    public static void main(String[] args) {
      ...
      //Arrays `i Stringe çeirme...toString(arr);->verilen arrìstring data type cevir
      String str=Arrays.toString(sayi1);
        System.out.println("str="+str);//[3,39,63,72,84]->arrìn tum karkterleri string olarak tanımlandı
