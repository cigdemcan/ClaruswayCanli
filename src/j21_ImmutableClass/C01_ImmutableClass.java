...
public class C01_ImmutableClass {
    public static void main(String[] args) {
        String str1="murat";//ilk değeri murat atanana str1 variable
        String str2="murat";//str1 ve str2 aynı ilk değere sahip olduğu içn String havuzunda ortak referans atanır
