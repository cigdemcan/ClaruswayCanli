 ...
 */
    ...
    private static void method01() {
        System.out.println(" *** method01 calısıyor *** ");
        ...
        System.out.println(" *** method01 bıttı *** ");
    }

    private static void method03() {
        System.out.println(" *** method03 calısıyor *** ");
        ebikGabık-=3;
        for (int y = 1; y <=5 ; y++) {
            System.out.print(y+" ");
    ...
    private static void method02() {
        System.out.println(" *** method02 calısıyor *** ");
        ebikGabık+=3;
        for (int x = 1; x <=7 ; x++) {
            System.out.print(x+" ");
